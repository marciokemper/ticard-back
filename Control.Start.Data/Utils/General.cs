...
namespace Control.Facilites.Data.Utils
{
    public static class General
    {
        ...
        /// </summary>
        /// <param name="password">String contendo a senha que deve ser criptografada para MD5 Hash</param>
